...
_REAL_SHAPED_DOCUMENT = {
    ...
    "modified_this_session": [
        ...
        },
        {
            ...
            "root_causes_fixed": [
                {
                    "id": "water_goal_percentage_self_reference",
                    "description": "referenced dead base-slug entity instead of live sensor.water_goal_percentage_3",
                    "substitutions": 6,
                    "entities_affected": [
                        "sensor.water_goal_percentage -> sensor.water_goal_percentage_3"
                    ],
                }
            ],
            "activation_status": "deployed_inactive_pending_reload_or_restart",
        ...
        {
            "file": "/config/packages/kitchen_cleaning_intelligence_v1_0_1_2608.yaml",
            "backup": "/config/packages/kitchen_cleaning_intelligence_v1_0_1_2608.yaml.bak_pre_dupfix_20260824T024111Z",
            "sha256_verified": True,
            "root_causes_fixed": [
                {
                    "id": "kitchen_cleaning_self_reference",
...
def test_explicit_mappings_are_imported() -> None:
    ...
    assert "sensor.water_goal_percentage" in stale_ids
...
def test_entries_without_explicit_mapping_are_skipped_not_guessed() -> None:
    result = _import()
    stale_ids = {item.stale_entity_id for item in result.accepted}
    # Neither vacuum_self_reference nor kitchen_cleaning_self_reference
    ...
    assert skipped_ids == {"vacuum_self_reference", "kitchen_cleaning_self_reference"}
