...
discussions, pull requests, and any other official communication channel
for this project), and also applies when an individual is officially
representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported via GitHub's [reporting tools](https://docs.github.com/en/communities/maintaining-your-safety-on-github/reporting-abuse-or-spam)
on this repository, or through GitHub's own Trust & Safety team if a
project maintainer is the subject of the report. All complaints will be
